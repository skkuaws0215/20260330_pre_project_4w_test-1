...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        help="Local path or S3 URI for pair_features_newfe_v2.parquet",
    )
    p.add_argument(
        "--labels-uri",
        default=f"s3://{TEAM_BUCKET}/results/features_nextflow_team4/abc_inputs/20260330_abc_v1/B/labels.parquet",
    )
    p.add_argument(
        "--output-prefix",
