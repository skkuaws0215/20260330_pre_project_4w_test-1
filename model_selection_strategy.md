...
- **70% run**: `s3://drug-discovery-joe-raw-data-team4/results/features_nextflow_team4/20260330_batch_miss70_v2/`
- **30% run**: `s3://drug-discovery-joe-raw-data-team4/results/features_nextflow_team4/20260330_batch_miss30_v2/`
- 현재 차이 컬럼(결측 필터 영향):
